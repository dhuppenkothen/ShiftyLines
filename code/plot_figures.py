...
def plot_test_noshift3(datadir="../data/"):
    data_file = datadir+"test_noshift3.dat"
    posterior_file = datadir+"test_noshift3_posterior_sample.txt"
    output_root = datadir+"test_noshift3"
    plot_results(data_file, posterior_file, output_root)
    return
...
def plot_test_shift2(datadir="../data/"):
