...
{
  pha_heg_p = load_fits(datadir, "oneline_sigma001_heg_p1_src.pha");
  pha_meg_p = load_fits(datadir, "oneline_sigma001_meg_p1_src.pha");
  pha_heg_m = load_fits(datadir, "oneline_sigma001_heg_m1_src.pha");
  pha_meg_m = load_fits(datadir, "oneline_sigma001_meg_m1_src.pha");
